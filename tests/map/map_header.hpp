...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/03 15:13:35 by dsaada            #+#    #+#             */
/*   Updated: 2023/01/06 11:38:48 by dsaada           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef MAP_HEADER_HPP
# define MAP_HEADER_HPP
...
template <typename T>
void init_map_array_int_str(NAMESPACE::pair<int, std::string>* arr, std::size_t size)
{
...
template <typename T>
void init_map_array_str_str(NAMESPACE::pair<std::string, std::string>* arr, std::size_t size)
{
...
#define SETUP_MAP_ARRAYS()                                                                         \
    ...
    init_map_array_int_str<void>(intstr_arr, 64);                                                  \
    NAMESPACE::pair<std::string, std::string> strstr_arr[32];                                      \
    init_map_array_str_str<void>(strstr_arr, 32);                                                  \
...
typedef NAMESPACE::map<int, std::string, std::less<int>,track_allocator<NAMESPACE::pair<const int, std::string> > > intmap;
typedef NAMESPACE::map<std::string, std::string, std::less<std::string>, track_allocator<NAMESPACE::pair<const std::string, std::string> > > strmap;
